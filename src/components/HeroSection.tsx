      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10 pt-24">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 opacity-0 animate-fade-up delay-500">
            <a
              href="https://wa.me/5511992232552?text=Ol%C3%A1%2C%20preciso%20de%20ajuda%20com%20um%20ve%C3%ADculo%20apreendido."
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#25D366] hover:bg-[#25D366]/90 text-white px-8 py-6 text-base font-bold tracking-wide rounded-xl transition-all duration-300 shadow-lg shadow-green-500/20 hover:shadow-green-500/40 hover:scale-105 flex items-center gap-3"
            >
